...
<div class="col-8 col-10-md px-3-md flex-wrap flex justify-between align-items-center z-10">
    ...
    <div class="flex-xxl d-none-md flex-wrap align-items-center justify-center">
        <a href="docs.html"><p class="px-4 fm flex flex-nowrap align-item-center nav-on">Documentation</p></a>
        <a href=""><p class="px-4 fm flex flex-nowrap align-items-center">Tutorials</p></a>
        <a href="../blog.html"><p class="px-4 fm flex align-items-center flex-nowrap">Blog</p></a>
        <a href=""><p class="px-4 fm flex align-items-center flex-nowrap">Support</p></a>
