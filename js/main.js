...
<div class="col-9 col-10-md px-3-md flex-wrap flex justify-between align-items-center z-10">
    <div class="flex py-2 align-items-center justify-between col-10-md">
        ...
        <a href="docs/docs.html" class="d-none-md"><p class="px-5 des py-2 flex flex-nowrap align-item-center nav-on caret">Docs
        </p></a>
        <a href="" class="d-none-md"><p class="px-5 des py-2 flex flex-nowrap align-items-center caret">Tutorials
        </p></a>
        <a href="blog.html" class="d-none-md"><p class="px-5 des py-2 flex align-items-center flex-nowrap caret">Blog
        </p></a>
        <a href="" class="d-none-md"><p class="px-5 des py-2 flex align-items-center flex-nowrap caret">Install
        </p></a>
...
for(let i = 0; i< caret.length; i++){
    caret[i].innerHTML += `
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" height="15px" width='20px'>
